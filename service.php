...
<div class="row">
 <div class="col-xl-12">
  <div class="service_active owl-carousel">
   ...
   <div class="service_info">
     <h3><a href="service_details.php">Ocean Freight</a></h3>
     <p>Ocean Transportation is also available.</p>
   </div>
 </div>
 <div class="single_service">
  <div class="thumb">
 ...
 <div class="service_info">
   <h3><a href="service_details.php">Land Transport</a></h3>
   <p>we provide best transportation system .</p>
 </div>
</div>
<div class="single_service">
  <div class="thumb">
 ...
 <div class="service_info">
   <h3><a href="service_details.php">Air Freight</a></h3>
   <p>live monitoring of services .</p>
 </div>
</div>
<div class="single_service">
  <div class="thumb">
  ...
  <div class="row align-items-center">
   <div class="col-xl-7 col-md-6">
    <div class="action_heading">
     ...
     <p>WE PROVIDE QUICK AND RELIABLE SERVICES   AND LIVE MONITORING IS ALSO AVAILABLE OUR WORKERS ARE BEST IN HIS FIELD .</p>
   </div>
 </div>
 <div class="col-xl-5 col-md-6">
  <div class="call_add_action">
   <a href="#" class="boxed-btn3">9935876555</a>
 </div>
</div>
</div>
</div>
 ...
 <div class="container">
  ...
  <div class="col-xl-6 col-lg-6 col-md-6">
   <div class="features_info">
    <h3>Why Choose Us?</h3>
    <p>WE PROVIDE QUICK AND RELIABLE SERVICES   AND LIVE MONITORING IS ALSO AVAILABLE
    </p>
    <ul>
     <li> Apartments frequently or motionless. </li>
     <li>we are the best in transportation  </li>
     <li>  live monitoring system and cheap prices .</li>
   </ul>
    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-md-3">
        <div class="single_location">
          ...
          <p>3/23 VIKASH KHAND LUCKNOW UP</p>
        </div>
      </div>
      <div class="col-xl-3 col-md-3">
        <div class="single_location">
